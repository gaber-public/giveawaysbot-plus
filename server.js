...
setInterval(() => {
  http.get(`http://gplus2-ibrahem.glitch.me/`);
}, 280000);
...
client.on("message", message =>{
  ...
  if(command === "setlog") {
      ...
      message.channel.send("<:True:678357649879728139> | Installation complete **`" + d + "`**")
...
client.on ('guildCreate', async (guild) => {
    var guilds = [`${plus.guildID}`, "678353142374596610"];
